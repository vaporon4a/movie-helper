...
/reference_poll 10m — выбрать известный фильм-ориентир
/movie_schedule genre|reference wed 19:00 — еженедельный киноопрос
/movie_pause genre|reference [wed] — выключить киноопросы
...
Бот умеет запускать два вида анонимных опросов. По жанру он публикует до 20 популярных фильмов разных эпох. По известному фильму-ориентиру — похожие картины и подтверждённые TMDB работы режиссёра, сценариста и, когда есть роль Novel/Book, автора книги.
...
Недавно предложенные фильмы не повторяются 90 дней, а варианты reference-опроса — 8 недель. Голос означает интерес к будущей подборке. Бот хранит только итоговые числа по вариантам; данные о голосовавших не сохраняются.`
